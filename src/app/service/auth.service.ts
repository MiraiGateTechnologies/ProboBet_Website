...
export class AuthService {
  ...
  login(code:string,password:string):Observable<User>{
    ...
    return this.http.post<User>(this.url,{code,password}).pipe(map(response=>{
     ...
     this.TOKEN_KEY = localStorage.setItem('token', 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJDMTk0NDAiLCJhdWQiOiIyIiwic2NvcGVzIjpbeyJhdXRob3JpdHkiOiIyIn1dLCJpc3MiOiJJU1NVRVIiLCJpYXQiOjE3MDcyMjIyNjEsImV4cCI6MTcwODA4NjI2MX0.w_7K27FDVnNqUt5K5i7iemeBmDEcsw9GYbQ4DDASFrs');
      return response;
    }))
  }
